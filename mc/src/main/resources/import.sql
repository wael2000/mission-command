insert into Battalion (id,name,description,status,systemStatus,systemMode,altitude,longitude,latitude) values (1,'Fox Team','fox-team','static','off','auto',0.0,0.0,0.0);
insert into Battalion (id,name,description,status,systemStatus,systemMode,altitude,longitude,latitude) values (2,'Hauk Team','hauk-team','static','off','auto',0.0,0.0,0.0);
insert into Battalion (id,name,description,status,systemStatus,systemMode,altitude,longitude,latitude) values (3,'Delta Team','delta-team','static','off','manual',0.0,0.0,0.0);
insert into Battalion (id,name,description,status,systemStatus,systemMode,altitude,longitude,latitude) values (4,'Mes Team','mes-team','static','off','auto',0.0,0.0,0.0);
insert into Battalion (id,name,description,status,systemStatus,systemMode,altitude,longitude,latitude) values (5,'Zwarte Team','zwarte-team','static','off','auto',0.0,0.0,0.0);
