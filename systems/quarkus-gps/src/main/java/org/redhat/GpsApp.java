...
/* This is the real application. It reads the configuration parameters,
 * create the gpsendpoint to read data from gpds and register listeners to be
 * informed when coordinates changes.
 * 
 * If then starts a background thread to report coordinates back to the
 * endpoint
 */
public class GpsApp implements QuarkusApplication {
    ...
    public int run(String... args) throws Exception {
        ...
        Thread reporterThread = new Thread(gpsReporter);
